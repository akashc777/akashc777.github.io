...
If you're new here: [OneCamp](https://onemana.dev/buy) is a self-hosted workspace — chat, docs, tasks, projects, calls, boards, tables, an API, and optional AI teammates. It runs on **your** infrastructure, with **your** choice of model.
...
*[OneCamp](https://onemana.dev/buy) is a self-hosted workspace. It now ships as two editions, v1 without AI and v2 with it: one payment, unlimited users, your server. Find it at [onemana.dev](https://onemana.dev/buy).*
